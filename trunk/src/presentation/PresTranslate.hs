...
translateIO :: ParseSheet -> LayerStatePres -> PresentationLevel -> EnrichedDocLevel -> EditPresentation -> IO (EditEnrichedDoc, LayerStatePres, PresentationLevel)
...
parseIO :: ParseSheet -> LayerStatePres -> PresentationLevel -> EnrichedDocLevel -> EditPresentation -> IO (EditEnrichedDoc, LayerStatePres, PresentationLevel)
...
parse :: ParseSheet -> LayerStatePres -> PresentationLevel -> EnrichedDocLevel -> EditPresentation ->
...
editParse :: ParseSheet -> LayerStatePres-> PresentationLevel -> EnrichedDocLevel -> (EditEnrichedDoc, LayerStatePres, PresentationLevel)
