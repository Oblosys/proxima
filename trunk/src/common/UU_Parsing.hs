...
, mk_range -- Martijn: added export, because <..> is not powerful enough when costs have to be changed
...
libBest' (Ok      ls) (NoMoreSteps _) lf rf = trace "Ambiguous" $ OkVal lf ls
libBest' (OkVal v ls) (NoMoreSteps _) lf rf = trace "Ambiguous" $ OkVal (lf.v) ls 
libBest' (NoMoreSteps _) (Ok      rs) lf rf = trace "Ambiguous" $ OkVal rf rs 
libBest' (NoMoreSteps _) (OkVal v rs) lf rf = trace "Ambiguous" $ OkVal (rf.v) rs 
libBest' (NoMoreSteps v) (NoMoreSteps _) lf rf = trace "Ambiguous" $ NoMoreSteps (lf v)
