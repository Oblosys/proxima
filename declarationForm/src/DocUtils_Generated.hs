...
rankNode (Node_BasicTask _ _) = 25
rankNode (Node_CompositeTask _ _) = 26
rankNode (Node_HoleTask _ _) = 27
rankNode (Node_ParseErrTask _ _) = 28
rankNode (Node_Description _ _) = 29
rankNode (Node_HoleDescription _ _) = 30
rankNode (Node_ParseErrDescription _ _) = 31
rankNode (Node_Sudoku _ _) = 32
rankNode (Node_HoleSudoku _ _) = 33
rankNode (Node_ParseErrSudoku _ _) = 34
rankNode (Node_Row _ _) = 35
rankNode (Node_HoleRow _ _) = 36
rankNode (Node_ParseErrRow _ _) = 37
rankNode (Node_Field _ _) = 38
rankNode (Node_HoleField _ _) = 39
rankNode (Node_ParseErrField _ _) = 40
rankNode (Node_Test _ _) = 41
rankNode (Node_HoleTest _ _) = 42
rankNode (Node_ParseErrTest _ _) = 43
rankNode (Node_StyledText _ _) = 44
rankNode (Node_HoleStyledText _ _) = 45
rankNode (Node_ParseErrStyledText _ _) = 46
rankNode (Node_Word _ _) = 47
rankNode (Node_HoleWord _ _) = 48
rankNode (Node_ParseErrWord _ _) = 49
rankNode (Node_WordPart _ _) = 50
rankNode (Node_OpenTag _ _) = 51
rankNode (Node_CloseTag _ _) = 52
rankNode (Node_HoleWordPart _ _) = 53
rankNode (Node_ParseErrWordPart _ _) = 54
rankNode (Node_TextBold _ _) = 55
rankNode (Node_TextItalic _ _) = 56
rankNode (Node_TextFontSize _ _) = 57
rankNode (Node_TextColor _ _) = 58
rankNode (Node_HoleTextStyle _ _) = 59
rankNode (Node_ParseErrTextStyle _ _) = 60
rankNode (Node_Int_ _ _) = 61
rankNode (Node_HoleInt_ _ _) = 62
rankNode (Node_ParseErrInt_ _ _) = 63
rankNode (Node_Float_ _ _) = 64
rankNode (Node_HoleFloat_ _ _) = 65
rankNode (Node_ParseErrFloat_ _ _) = 66
rankNode (Node_List_Expense _ _) = 67
rankNode (Node_HoleList_Expense _ _) = 68
rankNode (Node_ParseErrList_Expense _ _) = 69
rankNode (Node_List_Currency _ _) = 70
rankNode (Node_HoleList_Currency _ _) = 71
rankNode (Node_ParseErrList_Currency _ _) = 72
rankNode (Node_List_Task _ _) = 73
rankNode (Node_HoleList_Task _ _) = 74
rankNode (Node_ParseErrList_Task _ _) = 75
rankNode (Node_List_Word _ _) = 76
rankNode (Node_HoleList_Word _ _) = 77
rankNode (Node_ParseErrList_Word _ _) = 78
rankNode (Node_List_WordPart _ _) = 79
rankNode (Node_HoleList_WordPart _ _) = 80
rankNode (Node_ParseErrList_WordPart _ _) = 81
