...
\begin{scriptsize}
\put(-2,30){ \epsfig{file=pics/eps/WordprocessorWindow.eps, height=6cm}}
\put(0,146){ 
...
\put(0,30){ \epsfig{file=pics/eps/frame.eps, height=118pt} }
\put(193,34.6){ \makebox(170,110){#2}}
\put(200,30){ \epsfig{file=pics/eps/frame.eps, height=118pt} }
\end{scriptsize}
...
Proxima~\cite{prximaarch} will be able to handle all five use cases from Section~\ref{usecases}. It is designed according to the requirements from Section~\ref{sect:reqs}.
