...
The Proxima prototype is currently used to implement an editor for documenting Bayesian networks \ref{}. 
...
\pgffigure{A documentation editor for Bayesian networks.}{fig:bayesDocEditor} 
          {pics/Screenshots/BayesDocEditor}{829}{603}
