...
Unfortunately, this introduces yet another newtype constructor, which clutters the code of the combinators, since there is no natural place to handle it. 

%																
\subsection{Adding a monad}


To allow a layer function to perform IO operations, we 
\begin{small}
\begin{verbatim}
...
Consequentially, the \p{Step} type is also modified to account for a monadic result:
