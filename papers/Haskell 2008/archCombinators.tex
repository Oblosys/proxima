...
A drawback of the Drawback much complexity. If no type sig, type of combined layers is \p{a} with a whole lot of constraints. Certain type errors will be of the form \p{cannot deduce instance}. although still a lot are readable.
