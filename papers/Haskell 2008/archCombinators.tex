...
\dataa{$state$}\ar[rr] \ar `r[rd] `[rr] `[rrrr] `[rrrr] [rrrrr] & & \dimcomponent{5em}{2ex}{\present} \ar[ddd] \ar[r] &
     \dataa{$map$}\ar[rr] & & \dimcomponent{6em}{2ex}{\interpret} \ar[u] \ar[r] & \dataa{$state$} \\
& & & & & \hspace{3.5em} &  \\
& & & & & \hspace{3.5em} &  \\
...
\xymatrix@=0.6cm{
 ...
 \dataa{$state$}\ar[r]                    & \dimcomponent{5em}{2ex}{present} \ar[dd] \ar `r[d] `[dr] [dr] \ar[r] &
     \dataa{$map$}\ar@{.>}[r] & \dataa{$map$} \ar[r] & \dimcomponent{6em}{2ex}{interpret} \ar[u] \ar[r] & \dataa{$state$} \\
...
\xymatrix@=0.6cm{
 ...
 \dataa{{\tt state0}}\ar[r]  & \dimcomponent{5em}{2ex}{{\tt present}} \ar[dd] \ar `r[d] `[dr] [dr] \ar[r] &
     \dataa{{\tt map0}} \ar[r] & \dimcomponent{6em}{2ex}{{\tt interpret}} \ar[u] \ar[r] & \dataa{{\tt state0'}} \\
 ...
 \dataa{{\tt state1}}\ar[r]  & \dimcomponent{5em}{2ex}{{\tt present}} \ar[dd] \ar `r[d] `[dr] [dr] \ar[r] &
     \dataa{{\tt map1}} \ar[r] & \dimcomponent{6em}{2ex}{{\tt interpret}} \ar[u] \ar[r] & \dataa{{\tt state1'}} \\
 ...
 \dataa{{\tt state2}}\ar[r]  & \dimcomponent{5em}{2ex}{{\tt present}} \ar[dd] \ar `r[d] `[dr] [dr] \ar[r] &
     \dataa{{\tt map2}} \ar[r] & \dimcomponent{6em}{2ex}{{\tt interpret}} \ar[u] \ar[r] & \dataa{{\tt state2'}} \\
...
\begin{center}
\begin{center}
\epsfig{file=images/LayerDataFlow, width=\textwidth} % visio: LayerDataFlow.vsd
