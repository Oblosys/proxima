...
\todo{eerst twee stappen, maar later meer}
...
Figure~\ref{proximaDataFlow} shows the data flow for a single Proxima layer. 
...
Apart from the switched directions in \p{combine} and the fact that the monadic library is used, the definitions for the Proxima architecture are virtually the same as for \p{Simple}. Because of the similarity, we do not reproduce the entire architecture description here.
