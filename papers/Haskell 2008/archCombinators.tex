...
The structure of a generic version of \p{lift} in a pseudo-Haskell would read.
...
We can identify a variable arg composition that that takes n lift steps and composes them after applyin. call it compose <N> 
