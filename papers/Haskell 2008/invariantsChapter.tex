...
\bigskip \noindent
\xymatrix{
\dataa{Level$_0$ (Document level)} \\
\component{Layer$_0$} \\
\dataa{Level$_1$} \\
\cdots \\
\dataa{Level$_{n-1}$} \\
\component{Layer$_{n-1}$} \\
\dataa{Level$_n$ (Rendering level)}
}
\end{small}
...
\bigskip \noindent
\xymatrix{
 \dataa{$document$} \ar[dd] \ar[rr] & & \component{update} \ar[r] & \dataa{$document'$} \ar[dd] & \\
& & \dataa{$e_{Document}$} \ar[u] & & \\
\component{$present$} \ar[dd] \ar[r] & \dataa{$mapping$} \ar[r] & \component{$translate$} \ar[u] & \component{$present$} \ar[dd] \ar[r] & \dataa{$mapping'$} \\
& & \dataa{$gesture$} \ar[u] \ar@{.>}[d] & & \\
\dataa{$rendering$} \ar@{.>}[rr]  & & \component{EDIT} \ar@{.>}[r] & \dataa{$rendering'$} &
}
\end{small}
...
\bigskip \noindent
\xymatrix{
 \dataa{$document$} \ar[r] & \component{diff} \ar[r] & \dataa{$e_{Document}$} \\
& \dataa{$document'$} \ar[u] & \\ 
& \component{$Parser$} \ar[u] & \\
& \dataa{$rendering'$} \ar[u] & \\
\dataa{$rendering$} \ar[r]  & \component{update} \ar[u] & \dataa{$e_{Rendering}$} \ar[l] 
}
\end{small}
...
\xymatrix{
                                 & \dataa{$e_{Data_0}$} \\
 \dataa{$gesture$} \ar[ru] \ar@{}[u]^*{translate_0: \qquad} & \dataa{$e_{Data_1}$} \ar[u]  \\
\dots \ar[ru] \ar[u]             & \dots   \ar[u] \\
 \dataa{$gesture$} \ar[ru] \ar[u] & \dataa{$e_{Data_{n-2}}$} \ar[u] \\
\dataa{$gesture$} \ar[ru] \ar[u]^*{translate_{n-2}: \qquad}  & \dataa{$e_{Data_{n-1}}$} \ar[u] \\
\dataa{$gesture$} \ar[ru] \ar[u]^*{translate_{n-1}: \qquad } & 
}
\end{small}
...
\bigskip \noindent
\xymatrix{
                                            & \dataa{$Inj_{Edit_{Data_0}}~e_{Data_0}$\\$(gesture_0)$} \ar[dr] 
 &                                      & \\
\component{$translate_0$} \ar[ur] \ar[r]    & \dataa{$direct_0$} \ar[r]  
 & \component{$h$} \ar[r] \ar[ddr] \ar@{.}[dddr] \ar[ddddr] & \dataa{$e_{State_0}$} \\
\dataa{$gesture_1$} \ar[u]                   &                        
 &                                      & \\
\component{$translate_{1}$} \ar[u] \ar[r]   & \dataa{$direct_{1}$} \ar[uur]
 &                                      & \dataa{$e_{State_1}$} \\
\cdots \ar[u]                               & \cdots \ar@{.}[uuur]
 &                                      & \cdots \\
\dataa{$translate_{n-1}$} \ar[u] \ar[r] & \dataa{$direct_{n-1}$} \ar[uuuur]
 &                                      & \dataa{$e_{State_{n-1}}$} \\
\dataa{$Inj_{Gesture}~gesture$\\$(gesture_n)$} \ar[u]      &
 &                                      &
}
\end{small}
...
\xymatrix{
 ...
 &                                      & \\
\component{$translate_0$} \ar[ur] \ar[r]    & \dataa{$direct_0$} \ar[r]  
 & \component{$h_0$} \ar[d]  \ar[r] & \dataa{$e_{State_0}$} \\
\dataa{$gesture_1$} \ar[u]                            &                        
 & \dataa{$intermediate_{0}$} \ar[d]     & \\
\component{$translate_{1}$} \ar[u] \ar[r]   & \dataa{$direct_{1}$} \ar[r]
 & \component{$h_{1}$} \ar[d] \ar[r]    & \dataa{$e_{State_1}$} \\
\cdots \ar[u]                               & \cdots
 & \cdots \ar[d]                        & \cdots \\
\component{$translate_{n-1}$} \ar[u] \ar[r] & \dataa{$direct_{n-1}$} \ar[r]
 & \component{$h_{n-1}$} \ar[d] \ar[r]  & \dataa{$e_{State_{n-1}}$} \\
\dataa{$Inj_{Gesture}~gesture$\\$(gesture_n)$} \ar[u]                     &
 &  \dataa{$intermediate_{n}$}           &
}
\end{small}
...
\bigskip \noindent
\xymatrix{
 \dataa{$document$} \ar@{.>}[ddd] \ar[rr] & & \component{update} \ar[rrr] & & & \dataa{$document'$} \ar@{.>}[ddd] & \\
& &  \dataa{$e_{Document}$} \ar[u] \ar[r] & \component{$inc$} \ar[ddd] \ar[r] & \dataa{$e_{Mapping}$} \ar[d] & & \\ 
& \dataa{$mapping$} \ar[dr] \ar[rrr] & & &  \component{update} \ar[rr] & & \dataa{$mapping'$} \\
\abscomponent{$PRESENT$} \ar@{.>}[dd] \ar@{.>}[ur] & & \component{$translate$} \ar[uu] & & & \abscomponent{$PRESENT$} \ar@{.>}[dd] \ar@{.>}[ur] & \\
& & \dataa{$gesture$} \ar[u] \ar@{.>}[dd] &  \dataa{$e_{Rendering}$} \ar[d] & & & \\
\dataa{$rendering$} \ar@{.>}[drr] \ar[rrr] & & & \component{update} \ar[rr] & & \dataa{$rendering'$} & \\
...
\bigskip \noindent
\xymatrix{
\dataa{$e_{Document}$} \ar[r] & \component{update} \ar[d] & \dataa{$document$} \ar[l] \\
 & \dataa{$document'$} \ar[d] & \\ 
 & \component{$Presenter$} \ar[d] & \\
 & \dataa{$rendering'$} \ar[d] & \\
\dataa{$e_{Rendering}$} & \component{diff} \ar[l] & \dataa{$rendering$} \ar[l]  
}
\end{small}
