\documentclass[natbib,nocopyrightspace]{sigplanconf}
...
\TRtitlepage
{Haskell as an Architecture Description Language}  % argument 1 <= the title
{Martijn M. Schrage \\[1em] S. Doaitse Swierstra}                  % argument 2 <= authors
{UU-CS-2008-045}                                         % argument 3 <= report number
{December 2008}                                             % argument 4 <= the month and year
