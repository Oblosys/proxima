...
toXMLDocument (ParseErrDocument presentation tokens) = Elt "ParseErrDocument" [] []
toXMLRoot (Root _ decls) = Elt "Root" [] $ toXMLList_Decl decls
toXMLRoot (HoleRoot) = Elt "HoleRoot" [] $ []
toXMLRoot (ParseErrRoot presentation tokens) = Elt "ParseErrRoot" [] []
...
toXMLEnrichedDoc (ParseErrEnrichedDoc presentation tokens) = Elt "ParseErrEnrichedDoc" [] []
...
toXMLRootE (ParseErrRootE presentation tokens) = Elt "ParseErrRootE" [] []
...
toXMLDecl (ParseErrDecl presentation tokens) = Elt "ParseErrDecl" [] []
toXMLIdent (Ident _ _ string) = Elt "Ident" [] $ [toXMLString string]
toXMLIdent (HoleIdent) = Elt "HoleIdent" [] $ []
toXMLIdent (ParseErrIdent presentation tokens) = Elt "ParseErrIdent" [] []
...
toXMLExp (ParseErrExp presentation tokens) = Elt "ParseErrExp" [] []
toXMLAlt (Alt _ _ ident exp) = Elt "Alt" [] $ [toXMLIdent ident] ++ [toXMLExp exp]
toXMLAlt (HoleAlt) = Elt "HoleAlt" [] $ []
toXMLAlt (ParseErrAlt presentation tokens) = Elt "ParseErrAlt" [] []
...
toXMLBoard (ParseErrBoard presentation tokens) = Elt "ParseErrBoard" [] []
...
toXMLBoardRow (ParseErrBoardRow presentation tokens) = Elt "ParseErrBoardRow" [] []
...
toXMLBoardSquare (ParseErrBoardSquare presentation tokens) = Elt "ParseErrBoardSquare" [] []
...
toXMLPPPresentation (ParseErrPPPresentation presentation tokens) = Elt "ParseErrPPPresentation" [] []
toXMLSlide (Slide title itemList) = Elt "Slide" [] $ [toXMLString title] ++ [toXMLItemList itemList]
toXMLSlide (HoleSlide) = Elt "HoleSlide" [] $ []
toXMLSlide (ParseErrSlide presentation tokens) = Elt "ParseErrSlide" [] []
...
toXMLItemList (ParseErrItemList presentation tokens) = Elt "ParseErrItemList" [] []
...
toXMLListType (ParseErrListType presentation tokens) = Elt "ParseErrListType" [] []
