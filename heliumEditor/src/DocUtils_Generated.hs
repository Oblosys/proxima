...
rankNode :: Node -> Int
rankNode NoNode = 0
rankNode (Node_Root _ _) = 1
rankNode (Node_HoleRoot _ _) = 2
rankNode (Node_ParseErrRoot _ _) = 3
rankNode (Node_RootE _ _) = 4
rankNode (Node_HoleRootE _ _) = 5
rankNode (Node_ParseErrRootE _ _) = 6
rankNode (Node_Decl _ _) = 7
rankNode (Node_BoardDecl _ _) = 8
rankNode (Node_PPPresentationDecl _ _) = 9
rankNode (Node_HoleDecl _ _) = 10
rankNode (Node_ParseErrDecl _ _) = 11
rankNode (Node_Ident _ _) = 12
rankNode (Node_HoleIdent _ _) = 13
rankNode (Node_ParseErrIdent _ _) = 14
rankNode (Node_PlusExp _ _) = 15
rankNode (Node_TimesExp _ _) = 16
rankNode (Node_DivExp _ _) = 17
rankNode (Node_PowerExp _ _) = 18
rankNode (Node_BoolExp _ _) = 19
rankNode (Node_IntExp _ _) = 20
rankNode (Node_LamExp _ _) = 21
rankNode (Node_AppExp _ _) = 22
rankNode (Node_CaseExp _ _) = 23
rankNode (Node_LetExp _ _) = 24
rankNode (Node_IdentExp _ _) = 25
rankNode (Node_IfExp _ _) = 26
rankNode (Node_ParenExp _ _) = 27
rankNode (Node_ListExp _ _) = 28
rankNode (Node_ProductExp _ _) = 29
rankNode (Node_HoleExp _ _) = 30
rankNode (Node_ParseErrExp _ _) = 31
rankNode (Node_Alt _ _) = 32
rankNode (Node_HoleAlt _ _) = 33
rankNode (Node_ParseErrAlt _ _) = 34
rankNode (Node_Board _ _) = 35
rankNode (Node_HoleBoard _ _) = 36
rankNode (Node_ParseErrBoard _ _) = 37
rankNode (Node_BoardRow _ _) = 38
rankNode (Node_HoleBoardRow _ _) = 39
rankNode (Node_ParseErrBoardRow _ _) = 40
rankNode (Node_Queen _ _) = 41
rankNode (Node_King _ _) = 42
rankNode (Node_Bishop _ _) = 43
rankNode (Node_Knight _ _) = 44
rankNode (Node_Rook _ _) = 45
rankNode (Node_Pawn _ _) = 46
rankNode (Node_Empty _ _) = 47
rankNode (Node_HoleBoardSquare _ _) = 48
rankNode (Node_ParseErrBoardSquare _ _) = 49
rankNode (Node_PPPresentation _ _) = 50
rankNode (Node_HolePPPresentation _ _) = 51
rankNode (Node_ParseErrPPPresentation _ _) = 52
rankNode (Node_Slide _ _) = 53
rankNode (Node_HoleSlide _ _) = 54
rankNode (Node_ParseErrSlide _ _) = 55
rankNode (Node_ItemList _ _) = 56
rankNode (Node_HoleItemList _ _) = 57
rankNode (Node_ParseErrItemList _ _) = 58
rankNode (Node_Bullet _ _) = 59
rankNode (Node_Number _ _) = 60
rankNode (Node_Alpha _ _) = 61
rankNode (Node_HoleListType _ _) = 62
rankNode (Node_ParseErrListType _ _) = 63
rankNode (Node_StringItem _ _) = 64
rankNode (Node_HeliumItem _ _) = 65
rankNode (Node_ListItem _ _) = 66
rankNode (Node_HoleItem _ _) = 67
rankNode (Node_ParseErrItem _ _) = 68
rankNode (Node_List_Decl _ _) = 69
rankNode (Node_HoleList_Decl _ _) = 70
rankNode (Node_ParseErrList_Decl _ _) = 71
rankNode (Node_List_Alt _ _) = 72
rankNode (Node_HoleList_Alt _ _) = 73
rankNode (Node_ParseErrList_Alt _ _) = 74
rankNode (Node_List_Exp _ _) = 75
rankNode (Node_HoleList_Exp _ _) = 76
rankNode (Node_ParseErrList_Exp _ _) = 77
rankNode (Node_List_Slide _ _) = 78
rankNode (Node_HoleList_Slide _ _) = 79
rankNode (Node_ParseErrList_Slide _ _) = 80
rankNode (Node_List_Item _ _) = 81
rankNode (Node_HoleList_Item _ _) = 82
rankNode (Node_ParseErrList_Item _ _) = 83
