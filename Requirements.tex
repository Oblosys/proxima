...
\epsfig{file=pics/eps/HybridEditor.eps, width=3.5cm}
...
% \section{Requirements for a structure editor} 
% \label{requirements}
...
Proxima will be able to handle all five use cases from Section~\ref{usecases}. It is designed according to the requirements from Section~\ref{sect:reqs}.
