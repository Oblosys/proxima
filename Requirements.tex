...
\def\lastname{Schrage}
\begin{document}
\begin{frontmatter}
  \title{Requirements} \author{Martijn M. Schrage\thanksref{ALL}\thanksref{myemail}}
  \address{Institute of Information and Computing Sciences\\ Utrecht University\\
    Utrecht, The Netherlands} \author{Johan Jeuring\thanksref{coemail}}
  \address{Institute of Information and Computing Sciences\\ Utrecht University\\
    Utrecht, The Netherlands} \thanks[ALL]{Thanks
    to everyone who should be thanked} \thanks[myemail]{Email:
    \href{mailto:martijn@cs.uu.nl} {\texttt{\normalshape
        martijn@cs.uu.nl}}} \thanks[coemail]{Email:
    \href{mailto:johanj@cs.uu.nl} {\texttt{\normalshape
        johanj@cs.uu.nl}}}
\begin{abstract} 
  abstract\dots
\end{abstract}
...
%\put(1,33){ \epsfig{file=pics/eps/EqEdWin.eps, height=102.5pt}}
%\put(1,33){ \epsfig{file=pics/screenshots/Wordprocessor.png.eps, height=102.5pt}}
\end{scriptsize}
...
\screenshotWin{%\epsfig{file=pics/Screenshots/Wordprocessor.png.eps, height=6cm}
...
\put(5,30){ \epsfig{file=pics/eps/frameSmall.eps, height=70pt} }
\put(180,30){ \makebox(160,75){#2}}
\put(180,30){ \epsfig{file=pics/eps/frameSmall.eps, height=70pt} }
\end{scriptsize}
