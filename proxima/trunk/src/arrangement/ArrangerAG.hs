        ...
        let ( _presentationListIallFonts
             ...
             ,_presentationListIvStretchList
                ...
                (presentationList_ (_presentationListOallFonts)
                                   ...
                                   (_presentationListOxList)
                                   (_presentationListOyList))
            -- "../../proxima/src/arrangement/ArrangerAG.ag"(line 242, column 7)
            (_lhsOmaxFormatterDepth@_) =
                maximum _presentationListImaxFormatterDepthList
    ...
    \ _lhsIallFonts
      ...
      _lhsIy ->
        let ( _childIallFonts,_childIarrangement,_childIfinalHRef,_childIfinalHeight,_childIfinalVRef,_childIfinalWidth,_childIhRf,_childIhStretch,_childImaxFormatterDepth,_childIminHeight,_childIminWidth,_childIunfoldedTree,_childIvRf,_childIvStretch) =
            ...
            (_newSyn@_) =
                fst _newAttrs
            -- "../../proxima/src/arrangement/ArrangerAG.ag"(line 152, column 7)
            (_newAttrs@_) =
    ...
    \ _lhsIallFonts
      ...
      _lhsIyList ->
        let ( _hdIallFonts,_hdIarrangement,_hdIfinalHRef,_hdIfinalHeight,_hdIfinalVRef,_hdIfinalWidth,_hdIhRf,_hdIhStretch,_hdImaxFormatterDepth,_hdIminHeight,_hdIminWidth,_hdIunfoldedTree,_hdIvRf,_hdIvStretch) =
            ...
            -- "../../proxima/src/arrangement/ArrangerAG.ag"(line 270, column 7)
    ...
    \ _lhsIallFonts
      ...
      _lhsItextColor ->
        let ( _presentationIallFonts,_presentationIarrangement,_presentationIfinalHRef,_presentationIfinalHeight,_presentationIfinalVRef,_presentationIfinalWidth,_presentationIhRf,_presentationIhStretch,_presentationImaxFormatterDepth,_presentationIminHeight,_presentationIminWidth,_presentationIunfoldedTree,_presentationIvRf,_presentationIvStretch) =
            ...
            -- "../../proxima/src/arrangement/ArrangerAG.ag"(line 137, column 7)
            (_lhsOmaxFormatterDepth@_) =
