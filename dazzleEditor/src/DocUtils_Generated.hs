...
nodeRefIDD :: Node -> Maybe IDD
nodeRefIDD (NodeRefNode (NodeRef iDD _) _) = Just iDD
nodeRefIDD _                                   = Nothing

labelIDD :: Node -> Maybe IDD
labelIDD (LabelNode (Label iDD _) _) = Just iDD
labelIDD _                                   = Nothing

labelRefIDD :: Node -> Maybe IDD
labelRefIDD (LabelRefNode (LabelRef iDD _) _) = Just iDD
labelRefIDD _                                   = Nothing
...
shallowShowWord1 (NodeRef  _ _) = "NodeRef"
shallowShowWord1 (Label  _ _) = "Label"
shallowShowWord1 (LabelRef  _ _) = "LabelRef"
...
toXMLWord (NodeRef _ nodeName) = Elt "NodeRef" [] $ [toXMLString nodeName] ++ []
toXMLWord (Label _ label) = Elt "Label" [] $ [toXMLString label] ++ []
toXMLWord (LabelRef _ label) = Elt "LabelRef" [] $ [toXMLString label] ++ []
...
parseXMLCns_NodeRef = NodeRef NoIDD <$ startTag "NodeRef" <*> parseXML_String <* endTag "NodeRef"
parseXMLCns_Label = Label NoIDD <$ startTag "Label" <*> parseXML_String <* endTag "Label"
parseXMLCns_LabelRef = LabelRef NoIDD <$ startTag "LabelRef" <*> parseXML_String <* endTag "LabelRef"
