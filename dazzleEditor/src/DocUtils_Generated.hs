...
toXMLSection (ParseErrSection error) = Elt "ParseErrSection" [] []
...
toXMLSubsection (ParseErrSubsection error) = Elt "ParseErrSubsection" [] []
...
toXMLWord (ParseErrWord error) = Elt "ParseErrWord" [] []
...
toXMLGraph (ParseErrGraph error) = Elt "ParseErrGraph" [] []
...
toXMLSubgraph (ParseErrSubgraph error) = Elt "ParseErrSubgraph" [] []
