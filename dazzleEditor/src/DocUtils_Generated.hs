...
rankNode (HoleWordNode _ _)  = 20
rankNode (GraphNode _ _)  = 21
rankNode (HoleGraphNode _ _)  = 22
rankNode (VertexNode _ _)  = 23
rankNode (HoleVertexNode _ _)  = 24
rankNode (CircleNode _ _)  = 25
rankNode (SquareNode _ _)  = 26
rankNode (HoleShapeNode _ _)  = 27
...
parseXML_Word = parseXMLCns_Word <?|> parseXMLCns_NodeRef <?|> parseHoleAndParseErr "Word" HoleWord
