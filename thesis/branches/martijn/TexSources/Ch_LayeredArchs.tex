...
probably the best choice. edit model is already a bit explained previously. and one of the reasons for edit ops instead of levels is that single layer needs this.
