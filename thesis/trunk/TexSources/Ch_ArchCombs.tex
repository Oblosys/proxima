...
\xymatrix{
 ...
 \data{$state$}\ar[r] \ar@<-1ex> `r[d] `[rrr] `[rrr] `[rrrr] [rrrr] & \dimcomponent{5em}{2ex}{present} \ar[dd] \ar[r] &
     \data{$mapping$} \ar[rr] & & \dimcomponent{6em}{2ex}{interpret} \ar[u] \ar[r] & \data{$state$} \\
 & & & & \hspace{3.5em} &  \\
...
\xymatrix{
 ...
 \data{$state$}\ar[r] & \dimcomponent{5em}{2ex}{present} \ar[dd] \ar `r[d] `[dr] [dr] \ar[r] &
     \data{$mapping$}\ar@{.>}[r] & \data{$mapping$} \ar[r] & \dimcomponent{6em}{2ex}{interpret} \ar[u] \ar[r] & \data{$state$} \\
...
\xymatrix{
 ...
 \data{{\tt state0}}\ar[r] \ar@<-1ex> `r[d] `[rrr] `[rrr] `[rrrr] [rrrr] & \dimcomponent{5em}{2ex}{{\tt present}} \ar[dd] \ar[r] &
     \data{{\tt mapping0}} \ar[rr] & & \dimcomponent{6em}{2ex}{{\tt interpret}} \ar[u] \ar[r] & \data{{\tt state0'}} \\
 ...
 \data{{\tt state1}}\ar[r] \ar@<-1ex> `r[d] `[rrr] `[rrr] `[rrrr] [rrrr] & \dimcomponent{5em}{2ex}{{\tt present}} \ar[dd] \ar[r] &
     \data{{\tt mapping1}} \ar[rr] & & \dimcomponent{6em}{2ex}{{\tt interpret}} \ar[u] \ar[r] & \data{{\tt state1'}} \\
 ...
 \data{{\tt state2}}\ar[r] \ar@<-1ex> `r[d] `[rrr] `[rrr] `[rrrr] [rrrr] & \dimcomponent{5em}{2ex}{{\tt present}} \ar[dd] \ar[r] &
     \data{{\tt mapping2}} \ar[rr] & & \dimcomponent{6em}{2ex}{{\tt interpret}} \ar[u] \ar[r] & \data{{\tt state2'}} \\
