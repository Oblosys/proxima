...
Note that in constrast to the architecture description in Chapter~\ref{chap:proxArch}, $\present$ and $\interpret$ in the specification are functions between values rather than edit operations.
...
For a type $T$, the corresponding wildcard has type $*_T$ and is denoted by  $\texttt{*}_{T}$ (in a different font):
