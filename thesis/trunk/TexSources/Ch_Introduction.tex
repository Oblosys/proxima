...
% Description of levels  Description of layers
% Examples of presentation and interpretation


In Chapter~\ref{chap:informalSpec} and Chapter~\ref{chap:formalSpec}, we provide a specification of the Proxima editor. Chapter~\ref{chap:informalSpec} ... the edit process and introduces extra state and duplicates. 
...
Finally Chapter~\ref{chap:conclusions} presents the conclusions and discusses future work.  % Mention this one?
\bc
\begin{itemize}
