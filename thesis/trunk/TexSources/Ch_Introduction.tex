...
\tiny
\begin{tabular}{p{4cm}}
1.~Preliminaries 			\dotfill 1\\
~1.1~Structured documents \dotfill 1\\
~1.2~XML 				\dotfill 2\\
~1.3~Editing  			\dotfill 3\\\\
\dots
\end{tabular}
\end{minipage}
}
...
%\el
%
%Chapter~\ref{chap:informalSpec}:  ~\ref{chap:formalSpec}
%
%~\ref{chap:archCombs}
%~\ref{chap:presenting}
%~\ref{chap:prototype}
%
%As mentioned, users regard structure editors as being either overly restrictive, and/or not powerful enough. In the remainder of %this chapter, we first give a set of possible applications of structure editing, and then explore a number of functional %requirements that in our view are important for creating a flexible non-restrictive structure editor.
% zit al een beetje in next chapter intro.

%The outline of the remainder of this 
%Chapter~\ref{chap:requirements} explores the possible applications of generic structure editing, by providing five use cases of %real-world editors. With these use cases in mind, we formulate a number of requirements that in our view are important for a %flexible non-restrictive structure editor. The chapter also explains why current structure editors 
%
...
%~\ref{chap:informalSpec} ~\ref{chap:formalSpec}
%
%~\ref{chap:archCombs}
%~\ref{chap:presenting}
%~\ref{chap:prototype}
