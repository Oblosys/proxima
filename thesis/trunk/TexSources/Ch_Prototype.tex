...
\begin{center}
\protoscrshotStep{strEditList1.png.eps}{4.7}{~}{36} \then 
\protoscrshotStep{strEditList2.png.eps}{3.7}{\hspace*{-4.4cm}{\em cut} \p{3*5}}{36} \then 
\protoscrshotStep{strEditList3.png.eps}{4.7}{\hspace*{-4.3cm}{\em paste} \p{3*5}}{36}
\nopagebreak[4] \\ [2mm]
\begin{small}
\parbox{125mm}{\hspace*{3.85cm}{{\em cut} \p{3*5}}
\hspace{2.38cm} {\em paste} \p{3*5}}
...
\protoscrshotStep{strEditBuild1.png.eps}{4.7}{~}{32} \then
% geometry: 0,130 - ..x52
\protoscrshotStep{strEditBuild2.png.eps}{3.7}{\hspace*{-4.5cm} {\em add} \p{FracExp}}{38} \then
% geometry: 0,130 - 440x52
\protoscrshotStep{strEditBuild3.png.eps}{4.7}{\hspace*{-4.7cm} {\em insert} \p{PowerExp}}{42} 
\nopagebreak[4] \\ [2mm]
\begin{small}
\parbox{125mm}{\hspace*{2.92cm} {\em add} \p{FracExp}
\hspace{1.7cm}   {\em insert} \p{PowerExp}}
\end{small}\end{center}
...
\protoscrshotStep{presEdit1.png.eps}{4.7}{~}{42} \then
% geometry: 0,130 - ..x52
\protoscrshotStep{presEdit2.png.eps}{4.7}{\hspace*{-5.8cm} {\em cut} ``\p{+2, 27, 3*}''}{36}
\nopagebreak[4] \\ [2mm]
\begin{small}
\hspace*{1.00cm}{\em cut} ``\p{+2, 27, 3*}''
\end{small}
\end{center}
