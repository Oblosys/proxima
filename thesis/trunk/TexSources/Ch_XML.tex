\chapter{Requirements for a structure editor}
...
The screenshot \note{The screenshots in this chapter are still drafts because they may be replaced by actual Proxima screenshots.} shows the automatic-layout operation applied to the selected function {\tt isPrefixOf}. The layed-out function on the right-hand side is still freely editable, including its whitespace.
% comment handling?
...
In contrast, the Proxima editor is designed meet all six requirements and thus is able to handle all five use cases. In order to meet the requirements, Proxima makes use of the following concepts:
