...
The screen-shot shows the automatic-layout operation applied to the selected function {\tt isPrefixOf}. The layed-out function on the right-hand side is still freely editable, including its whitespace.
% comment handling?
