...
%{\small 2~~Editing~structured~documents}\\
%\vspace{0.001cm}
%\parbox{5.2cm}{While the term {\em editor} is usually only associated with plain-text editors such as %Emacs~\cite{stallman81emacs} or the ubiquitous Microsoft Notepad, we will use the 
% ~~~~~~~~~~~~~~~~~\strut
%}
%\end{tabular}
%\end{tiny}
