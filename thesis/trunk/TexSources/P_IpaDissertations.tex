...
%\clearpage
%\pagestyle{empty}
\chapter*{Titles in the IPA dissertation series}
\addcontentsline{toc}{chapter}{Titles in the IPA dissertation series}

\footnotesize
\setlength{\columnsep}{2em}
\begin{multicols}{2}
%        [\subsection*{Titles in the IPA Dissertation Series}]
