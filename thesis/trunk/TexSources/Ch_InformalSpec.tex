...
\note{Mention imprecise edit? When interpreted presentation is much different from final presentation, es reuse may be tricky (e.g.\ after entering "{\tt ->}", final presentation is "$\rarr$"?)}
