...
%\newcommand{\subtitle}{Chapters 2\&3}     \include{P_AltTitlePages}
...
\setcounter{chapter}{4} \include{Ch_InformalSpec}	% 5
\setcounter{chapter}{5} \include{Ch_FormalSpec}	% 6
%\setcounter{chapter}{6} \include{Ch_LayeredArchs}	% 7
%\setcounter{chapter}{7} \include{Ch_ArchCombs}	% 8
%\setcounter{chapter}{8} \include{Ch_Xprez}   		% 9
%\setcounter{chapter}{9} \include{Ch_Prototype}    	% 10 yet to be written
%\setcounter{chapter}{10} \include{Ch_Conclusions}	% 11 yet to be written
