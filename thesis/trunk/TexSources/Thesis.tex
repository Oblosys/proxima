...
%\setcounter{chapter}{4} \bc \setcounter{page}{89}\ec \include{Ch_FormalSpec}	% 5
               %%%%%\setcounter{chapter}{5} \include{Ch_ArchCombs}	% 6
%\setcounter{chapter}{5} \include{Ch_Xprez}   		% 7
\setcounter{chapter}{7} \setcounter{page}{157} \include{Ch_Prototype}    	% 8
\setcounter{chapter}{8} \bc \setcounter{page}{177} \ec \include{Ch_Conclusions}	% 9 yet to be written
