...
Section~\ref{\ch:sect:targetlangs} discusses existing presentation target languages, followed by the introduction of the target language of {\sc Xprez} in Section~\ref{xpreztarget}. *** Include this section? *** Section\bc ~\ref{transformlangs} \ec deals with the transformation languages and Section~\ref{\ch:sect:conclusions} concludes.
